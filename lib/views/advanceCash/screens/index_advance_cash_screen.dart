...
import 'package:hrm/views/advanceCash/widgets/advancecash_list_widget.dart';

import 'create_advance_cash_screen.dart';

class IndexAdvanceCashScreen extends StatelessWidget {
  IndexAdvanceCashScreen({super.key});
              ...
              child: FloatingActionButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const CreateAdvanceCashScreen(),
                    ),
                  );
                },
                child: const Icon(
